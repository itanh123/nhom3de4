...
<div class="mb-4 animate-up">
    <h2 class="mb-0"><i class="bi bi-journal-text me-2 text-primary"></i>Danh sách Bài thi</h2>
</div>
...
<div class="row g-4">
    ...
    <div class="col-md-6 col-lg-4 animate-up" style="animation-delay: {{ $index * 0.1 }}s">
