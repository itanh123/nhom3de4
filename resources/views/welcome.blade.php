    ...
    <div class="col-md-4">
        <div class="card h-100">
            <div class="card-body text-center">
                ...
                <p class="card-text text-muted">Tạo và quản lý các chủ đề bài thi</p>
            </div>
        </div>
    </div>
    <div class="col-md-4">
        <div class="card h-100">
            <div class="card-body text-center">
                ...
                <p class="card-text text-muted">Tạo và quản lý câu hỏi thi</p>
            </div>
        </div>
    </div>
    <div class="col-md-4">
        <div class="card h-100">
            <div class="card-body text-center">
                <h5 class="card-title">Tạo Bài Thi</h5>
                <p class="card-text text-muted">Sinh bài thi từ ngân hàng câu hỏi</p>
            </div>
        </div>
    </div>
</div>
