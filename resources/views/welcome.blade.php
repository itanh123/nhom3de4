...
@if (Route::has('login'))
    <a href="{{ route('login') }}" class="px-4 py-2 text-primary font-medium hover:bg-surface-container-low transition-all duration-200 rounded-xl active:scale-95">Đăng nhập</a>
@endif
...
<img alt="Education" class="w-full h-full object-cover group-hover:scale-110 transition-transform duration-500" src="https://lh3.googleusercontent.com/aida-public/AB6AXuB3CUr4fi6NK-YSIdL35lGPytE36d5ukrEBuTDBb8_p4CaCJbtz6Hh2ddBnU5Mvpx05PLS8e_wyS49lUgun4-yWKFWY6Jr-x5FV8hu2VEXQufABGPV7vvJms2vBZkTBxdfznFnymVMfIxkGhBfrFAIlDIDsAilWzBRUM8reBrlUE4kHb0C4oGRBMGxvQPXD5B6LH01OCMD91Om8i4UAkBhVq7HgW5J6x0HdMJgC6afVoytggfx7wNk4dtA0Y2ffvdLX9i_n5JJl_x8"/>
</div>
<div class="space-y-4">
...
<div class="group bg-surface-container-lowest rounded-[1.5rem] p-6 shadow-sm hover:shadow-xl hover:-translate-y-2 transition-all duration-300 border border-outline-variant/10">
<div class="h-48 mb-6 overflow-hidden rounded-xl bg-slate-100">
<img alt="Technology" class="w-full h-full object-cover group-hover:scale-110 transition-transform duration-500" src="https://lh3.googleusercontent.com/aida-public/AB6AXuAItOASHnXiqzqze7qW7Fg7v3eFM634SIxiJBIlUnM6aZsb1h6Rc3Tf-n2ufku_dHEkZJww2KTcG2tAdK7JlYjHOFiKKbLi5UfWJYgeefaDW2E5IMQm06ZFRM4FiyzMDk-O8NnPkZiHB1Kk6h_blFzs1z46XwLoNjBdLJb56OPTgzsi92ASrlaRboIRQ1UuqTnl9ugjhT2hzhlQDAqLVLztHiFtd_qvArgqJtMxX9qM5WVdI3KI0PF7ORAYaMGoY2L_pHApAxztY9o"/>
</div>
<div class="space-y-4">
...
<div class="group bg-surface-container-lowest rounded-[1.5rem] p-6 shadow-sm hover:shadow-xl hover:-translate-y-2 transition-all duration-300 border border-outline-variant/10">
<div class="h-48 mb-6 overflow-hidden rounded-xl bg-slate-100">
<img alt="History" class="w-full h-full object-cover group-hover:scale-110 transition-transform duration-500" src="https://lh3.googleusercontent.com/aida-public/AB6AXuBadJLlDBUxBijgmcRkhCvjqZPUZjBKAkfUWbWglxtYSyCqYMTOOm8VM0PSr9MWNdMRhv1tQ1hp5EEXDsLmhUIEfBa4y1FNJMbrl2k1LA_TQFl20yk1_h4cAXMvYL9SFp3Bn2YO3217NC5lKL1U5L-9RbDzXMTeIB-cjFw6iWqqQKa84B7HHzZFomsWimE466fYE_YRTNi7Obk7ybg0Qv28mAB7G-ZEuSHhSpGtPl-aehudgDt9j2twEWAIQiUzSFUqxN1EkBrVvy8"/>
</div>
<div class="space-y-4">
